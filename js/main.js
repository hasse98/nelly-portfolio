...
const translations = {
  sv: {
    ...
    'approach.pillar3.desc': 'Arkitektur ska kunna växa och förändras med de människor den tjänar. Flexibla strukturer som möter framtida behov utan att förlora sin identitet.',
    'tools.title': 'Verktyg',
    'tools.editing': 'Redigering',
    'tools.drawing': 'Ritning',
    'tools.modeling': 'Modellering',
    'tools.visualization': 'Visualisering',
  ...
  en: {
    ...
    'approach.pillar3.desc': 'Architecture should grow and change with the people it serves. Flexible structures that meet future needs without losing their identity.',
    'tools.title': 'Tools',
    'tools.editing': 'Editing',
    'tools.drawing': 'Drawing',
    'tools.modeling': 'Modeling',
